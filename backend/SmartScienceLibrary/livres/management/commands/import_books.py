...
class Command(BaseCommand):
    ...
    def import_books(self, sujet):
        ...
        for item in items:
            ...
            categorie, _ = Categorie.objects.get_or_create(name=sujet.capitalize())
            ...
            # if created:
            #     self.stdout.write(self.style.SUCCESS(f"Ajouté : {titre}"))
            # else:
            #     self.stdout.write(f"Déjà présent : {titre}")
